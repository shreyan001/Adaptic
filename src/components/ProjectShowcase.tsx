  ...
  return (
    <div className="bg-white border-2 border-black p-8">
      ...
      <div className="text-center mb-12">
        <div className="w-20 h-20 bg-black text-white border-2 border-black flex items-center justify-center mx-auto mb-6">
          <Bot className="h-10 w-10" />
        </div>
        <h1 className="text-4xl font-bold geist-mono uppercase tracking-wider mb-4">
          ADAPTIC PROTOCOL
        </h1>
        <p className="text-xl geist-mono mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
        <div>
          <h2 className="text-2xl font-bold geist-mono uppercase tracking-wider mb-6">
            SYSTEM ARCHITECTURE
          </h2>
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold geist-mono uppercase tracking-wider mb-2">
                  AI PROCESSING ENGINE
                </h3>
                <p className="text-sm geist-mono leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="card">
              ...
              <ul className="list-none space-y-1">
                <li className="text-sm geist-mono flex items-center">
      ...
      {/* Key Features */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold geist-mono uppercase tracking-wider mb-6 text-center">
          KEY FEATURES
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="card text-center">
            <div className="w-12 h-12 bg-black text-white border-2 border-black flex items-center justify-center mx-auto mb-4">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card">
            <h3 className="font-bold geist-mono uppercase tracking-wider mb-3">
              TICKETING NFTS
            </h3>
            <p className="text-sm geist-mono mb-3">
              EVENT TICKETS THAT TRANSFORM INTO COLLECTIBLES POST-EVENT, WITH AUTONOMOUS VERIFICATION AND RESALE RESTRICTIONS.
            </p>
            <ul className="list-none space-y-1">
              <li className="text-xs geist-mono flex items-center">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold geist-mono uppercase tracking-wider mb-4">
          READY TO BUILD?
        </h2>
        <p className="text-lg geist-mono mb-6">
        ...
        <p className="text-sm geist-mono uppercase tracking-wider mt-4 text-gray-600">
          START WITH OUR AI-POWERED CHAT INTERFACE
        </p>
        
        <div className="mt-8 text-xs geist-mono uppercase tracking-wider text-center">
